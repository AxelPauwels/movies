...
<div id="over" class="pad-section">
    <div class="container">
        <div class="row">
            <div class="col-sm-6 imageApp">
                <?php echo image('/app/logoApp.png', 'alt="App logo"') ?>
            </div>
...
<div id="ontwikkeling" class="pad-section">
    <div class="container">
        <h2 class="text-center">Ontwikkeling</h2> <hr />
        <div class="row text-center ontwikkelIcoon">
            ...
            <div class="col-lg-2 col-md-2 col-sm-2 col-xs-6">
                <svg viewBox="0 0 128 128">
                    <path fill="#4E6BA9" d="M64 33.039c-33.74 0-61.094 13.862-61.094 30.961s27.354 30.961 61.094 30.961 61.094-13.862 61.094-30.961-27.354-30.961-61.094-30.961zm-15.897 36.993c-1.458 1.364-3.077 1.927-4.86 2.507-1.783.581-4.052.461-6.811.461h-6.253l-1.733 10h-7.301l6.515-34h14.04c4.224 0 7.305 1.215 9.242 3.432 1.937 2.217 2.519 5.364 1.747 9.337-.319 1.637-.856 3.159-1.614 4.515-.759 1.357-1.75 2.624-2.972 3.748zm21.311 2.968l2.881-14.42c.328-1.688.208-2.942-.361-3.555-.57-.614-1.782-1.025-3.635-1.025h-5.79l-3.731 19h-7.244l6.515-33h7.244l-1.732 9h6.453c4.061 0 6.861.815 8.402 2.231s2.003 3.356 1.387 6.528l-3.031 15.241h-7.358zm40.259-11.178c-.318 1.637-.856 3.133-1.613 4.488-.758 1.357-1.748 2.598-2.971 3.722-1.458 1.364-3.078 1.927-4.86 2.507-1.782.581-4.053.461-6.812.461h-6.253l-1.732 10h-7.301l6.514-34h14.041c4.224 0 7.305 1.215 9.241 3.432 1.935 2.217 2.518 5.418 1.746 9.39zM95.919 54h-5.001l-2.727 14h4.442c2.942 0 5.136-.29 6.576-1.4 1.442-1.108 2.413-2.828 2.918-5.421.484-2.491.264-4.434-.66-5.458-.925-1.024-2.774-1.721-5.548-1.721zM38.934 54h-5.002l-2.727 14h4.441c2.943 0 5.136-.29 6.577-1.4 1.441-1.108 2.413-2.828 2.917-5.421.484-2.491.264-4.434-.66-5.458s-2.772-1.721-5.546-1.721z"></path>
                </svg>
                <h4>PHP</h4>
            </div>
            <div class="col-lg-2 col-md-2 col-sm-2 col-xs-6">
            ...
            <div class="col-lg-2 col-md-2 col-sm-2 col-xs-6">
                <?php echo image('/app/logoMaterialize.png', 'alt="App logo" class="materialize"') ?>
                <h4>Materialize</h4>
            </div>
            <div class="col-lg-2 col-md-2 col-sm-2 col-xs-6">
                <svg viewBox="0 0 128 128">
            ...
            <div class="col-lg-2 col-md-2 col-sm-2 col-xs-6">
                <?php echo image('/app/logoApache.png', 'alt="App logo" class="apache"') ?>
                <h4>Apache</h4>
            </div>
            <div class="col-lg-2 col-md-2 col-sm-2 col-xs-6">
                <svg viewBox="0 0 128 128">
...
<div id="informatie" class="pad-section">
    <div class="container">
        <div class="row">
            <div class="col-sm-6">
                <div class="panel panel-default">
                    <div class="panel-heading">
                        <h2 class="panel-title">Informatie over de app</h2>
                    </div>
                    <div class="panel-body lead">
                        Ik heb deze applicatie ontwikkeld als project voor het vak Cordova in de IT Factory aan de hogeschool Thomas More. 
                        Met de meegegeven basiskennis en het intensieve opzoekingswerk realiseerde ik deze app voor Android. 
                        Om te voldoen aan de eisen van het project heb ik geprogrammeerd met HTML, PHP, Javascript, Ajax, JSON, CSS en geconnecteerd naar mijn Raspberry Pi database. 
                        Buiten het feit dat ik veel geleerd heb over het ontwikkelen van apps heb ik me ook goed kunnen uitleven.
                        Als IDE gebruikte ik PHPStorm voor de app het framework CodeIgniter voor deze website.
                    	Deze app is volledig responsief op alle devices.
			</div>
                </div>
            </div>
            <div class="col-sm-6">
                <div class="panel panel-default">
                    <div class="panel-heading">
                        <h2 class="panel-title">Functies van de app</h2>
                    </div>
                    <div class="panel-body lead">
                        Met deze App blijf je op de hoogte van welke films ik in mijn collectie heb. 
                        Ter gebruiksvriendelijkheid kan je zoeken naar een film en vervolgens deze resultaten sorteren op naam of jaar (zowel oplopend als aflopend). 
                        Door op een film te klikken krijg je de cover te zien met de basisgegevens over de film. 
                        Je kan klikken op “meer info” die je naar IMDb brengt, of toevoegen aan je favorieten. 
                        Je kan favorieten toevoegen, bewerken, delen of kopiëren naar het klembord om te plakken waar je wil. 
                        De app geeft informatie over je toestel en netwerk. 
                        Je kan mij telefonisch contacteren of via sms of mail.
                        Er zijn ook enkele lettertypes beschikbaar die je kan instellen voor de app.
                        Tenslotte kan je de meest belangrijke broncodes bekijken om te zien hoe deze app is geprogrammeerd.                    </div>
                </div>
            </div>
        </div>
    </div>
...
<div id="apk" class="pad-section">
    <div class="container">
        <h2 class="text-center">Download</h2> <hr />
        <div class="row text-center">
            <div class="col-sm-2 col-xs-2 col-sm-offset-3 col-xs-offset-3  dowloadAPK">    
                <p><a href="<?php echo base_url('assets/android-debug.apk') ?>"> <i class="fa fa-download fa-5x" aria-hidden="true"></i><a></p>
            </div>
            <div class="col-sm-2 col-xs-2 col-sm-offset-2 col-xs-offset-2 imageAPK">
                <p><?php echo image('/app/logoQR.jpg', 'alt="App logo"') ?></p>
            </div>
        </div>
    </div>
</div>
...
<div id="myCarousel" class="carousel slide col-sm-12 col-xs-12 iphoneFrame" data-ride="carousel">
    <!-- Indicators -->
  ...
  <div class="carousel-inner " role="listbox">
    <div class="item active ">
      <?php echo image('/app/1.png', 'class="center-block" alt="Screenshot Home" width="262" height="450"') ?>
    </div>
    <div class="item ">
      <?php echo image('/app/2.png', 'class="center-block" alt="Screenshot Navigatie" width="262" height="450"') ?>
    </div>
    <div class="item">
      <?php echo image('/app/3.png', 'class="center-block" alt="Screenshot Info" width="262" height="450"') ?>
    </div>
    <div class="item">
      <?php echo image('/app/4.png', 'class="center-block" alt="Screenshot Device" width="262" height="450"') ?>
    </div>
    <div class="item">
      <?php echo image('/app/5.png', 'class="center-block" alt="Screenshot Movies" width="262" height="450"') ?>
    </div>
    <div class="item">
      <?php echo image('/app/6.png', 'class="center-block" alt="Screenshot movieDetails" width="262" height="450"') ?>
    </div>
    <div class="item">
      <?php echo image('/app/7.png', 'class="center-block" alt="Screenshot Favorieten" width="262" height="450"') ?>
    </div>
    <div class="item">
      <?php echo image('/app/8.png', 'class="center-block" alt="Screenshot Contact" width="262" height="450"') ?>
    </div>
    <div class="item">
      <?php echo image('/app/9.png', 'class="center-block" alt="Screenshot Codes" width="262" height="450"') ?>
    </div>
  </div>
    ...
    <div class="container">
        <div class="row text-center">
            <div class="col-sm-12 col-xs-12 ">    
                <p><i class="fa fa-user-secret" aria-hidden="true"></i> Axel Pauwels</p>
                <p><i class="fa fa-envelope" aria-hidden="true"></i> info.movieserver@gmail.com</p>
                <p><i class="fa fa-phone" aria-hidden="true"></i> 0477/968800</p>
            </div>
        </div>
    </div>
</div>
